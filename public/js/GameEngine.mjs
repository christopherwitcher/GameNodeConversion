...
export class GameEngine {
    ...
    loop() {
        ...
        this.update();
        this.viewPort.update(); // update the viewPort with Player's new coordinates
        this.draw();
    ...
    */
    update() {
        ...
        // add or remove keydown addListeners depending on whether Player is currently jumping
        ...
        for (var i = 0; i < entitiesCount; i++) {
            ...
            if (entity instanceof GameTimer && !this.gameOver) {
                if (Number(entity.time) > this.gameTimeLength) {
                    this.running = false;
                    this.gameOver = true;
                    this.endGame();
                }
            ...
            // 5/28 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            // Update all entities' x value except Player
            if (!(entity instanceof Player)) {
                entity.x = this.canvasWidth + (entity.worldX - this.viewPort.rightX);
            }
